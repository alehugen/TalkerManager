...
Seja bem-vindo ao Projeto Talker Manager, realizado durante meu período de estudos durante a Trybe, com a finalidade te avaliar alguns aprendizados.
...
Usei o [Jest](https://jestjs.io/pt-BR/) e o [Frisby](https://docs.frisbyjs.com/) para fazer os testes de api.
...
Este projeto foi disponibilizado pela Trybe como forma de avaliação do aprendizado do bloco respectivo, a descrição de todos os requisitos foram feitas por eles, sendo somente a solução dos respectivos foram realizadas por mim :D
